    ...
    <div className="space-y-6">
      <div>
        ...
        <ul className="space-y-1">
          ...
          <li><label><input type="checkbox" className="mr-2" /> Jordan</label></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-1">
          <li><label><input type="checkbox" className="mr-2" /> 7</label></li>
          <li><label><input type="checkbox" className="mr-2" /> 8</label></li>
          <li><label><input type="checkbox" className="mr-2" /> 9</label></li>
        </ul>
      </div>
