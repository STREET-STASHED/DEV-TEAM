...
export default function Marketplace() {
  ...
  const categories = ["All", "Stylists", "Streetwear", "Luxury", "Essentials", "Shoes"];
  ...
  useEffect(() => {
    ...
    async function fetchStylists() {
      ...
      if (error || !data || data.length === 0) {
        const mockStylists: Stylist[] = Array.from({ length: 6 }, (_, index) => ({
          id: `sty-${index}`,
    ...
    <Layout>
      ...
      >
        ...
        {selectedTab === "Stylists" ? (
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {(selectedTab === "All" ? allProducts : visibleStores.flatMap((store) =>
