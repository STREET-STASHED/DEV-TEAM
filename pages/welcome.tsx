...
export default function WelcomePage() {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 py-12 bg-[url('/bg/graffiti.png')] bg-cover bg-center bg-fixed">
      <div className="max-w-2xl w-full bg-black/80 p-8 rounded-xl shadow-xl space-y-6 border border-gold">
