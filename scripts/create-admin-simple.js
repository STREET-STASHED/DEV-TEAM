...
// This script directly queries the database to create an admin user
...
async function createAdminUser() {
  try {
    ...
    if (usersError) {
      ...
      // Alternative: Check if user exists in profiles
      ...
      if (profiles && profiles.length > 0) {
        console.log('✅ Found existing profile, updating to admin...')
